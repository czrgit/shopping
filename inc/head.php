	...
	<div class="nav">
	 ...
	 <?php
			...
			if(isset($_SESSION['user'])){
				echo "<a href='user/showOrder.php?uid=".$_SESSION['uid']."'>查看订单</a>";
				echo "<a href='user/user.php?uid=".$_SESSION['uid']."'>用户信息</a>";
				echo "<a href='#'>".$_SESSION['user'].",欢迎您！</a>";
				echo "<a href='user/loginout.php'>退出</a>";
				
				
				}else{
					echo "<a href='user/reg.php'>注册</a>";
					echo "<a href='user/login.php'>登陆</a>";
