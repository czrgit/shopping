...
$sql="select oid,gname,gprice,onum,otime,uRealName,uTel,buyType from goodsorder,userform,goods where goodsorder.uid=userform.uid and goodsorder.gid=goods.gid";
$result=mysql_query($sql);
	if($rs=mysql_fetch_array($result)){
		$sum=0;
		$num=0;
		echo '<table class="order" width="900" align="center" border="0">';
		echo "<tr><th>订单号</th><th>商品名称</th><th>单价</th><th>数量</th><th>下单时间</th><th>姓名</th><th>电话</th><th>付款方式</th><th>删除订单</th></tr>";
		do{
			...
			echo "<td><a href='delshowOrder.php?oid=".$rs['oid']."'>删除</a></td>";
			echo "</tr>";
